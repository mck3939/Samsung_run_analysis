...
The data is tidy because each row contains one activity per row and the columns only contain one piece of data each. Column names have also be updated to all lower case and only alphanumieric characters.  
